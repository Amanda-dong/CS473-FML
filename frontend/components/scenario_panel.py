"""Scenario controls — cuisine subtype, price tier, risk tolerance."""
...
def _render_cuisine_picker(subtypes: list[str]) -> str:
    display_labels = [
    ...
    selected_idx = st.selectbox(
        ...
        help="Pick the cuisine subtype you want to score across NYC zones.",
    )
    ...
    if selected == "__custom__":
        custom = st.text_input(
            "Enter a custom cuisine concept",
            placeholder="Examples: halal smash burgers, vegan ramen, late-night Korean grill...",
...
def render_scenario_panel() -> dict[str, str | bool | None]:
    ...
    price_tier = st.selectbox(
        ...
        help="Choose value-oriented, mainstream mid-market, or premium positioning.",
    )
