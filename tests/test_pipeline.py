...
def test_build_feature_matrix_stage_returns_null_free_dataframe(tmp_path, monkeypatch) -> None:
    ...
    with patch("src.features.feature_matrix.build_zone_year_matrix") as mock_build_zones:
