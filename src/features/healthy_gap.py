"""Placeholder scoring helpers for healthy-food white space."""
...
def score_healthy_gap(zone_features: Mapping[str, float]) -> dict[str, float]:
    """Compute a transparent placeholder gap score for a single zone."""
    ...
    score = max(0.0, (quick_lunch_demand * 0.5) + (subtype_gap * 0.35) - (healthy_supply_ratio * 0.25))
    return {
