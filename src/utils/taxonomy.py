...
_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "mediterranean_bowls":  ("mediterranean", "cava", "naya", "grain bowl", "falafel bowl", "shawarma bowl"),
    "vegan_grab_and_go":    ("vegan", "plant-based", "vegetarian grab"),
    "protein_forward_lunch":("high-protein", "protein-forward", "lean lunch", "macro bowl"),
    ...
    "japanese":             ("japanese", "sushi", "sashimi", "izakaya", "teriyaki", "udon", "tempura"),
    ...
    "mexican":              ("mexican", "taco", "burrito", "torta", "birria", "tlayuda", "enchilada"),
    ...
    "middle_eastern":       ("middle eastern", "lebanese", "hummus", "mezze", "persian", "turkish"),
    ...
    "american_comfort":     ("american comfort", "diner", "bbq", "fried chicken", "mac and cheese"),
